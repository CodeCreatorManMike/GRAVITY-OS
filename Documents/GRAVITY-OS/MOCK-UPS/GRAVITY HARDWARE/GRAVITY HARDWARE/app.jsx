...
function ObjectSection() {
  const callouts = [
    ...
    ["FINISH", "Matte-black ABS / PETG, soft-touch coat. Convex back fits a cupped palm. 3D-printed for the demo."],
    ["BACK", "Clean convex back — no buttons, no ports. A flip-out backstand hides flush and pops out with a fingernail to free-stand the device off its base."],
  ...
  return (
    <section className="section">
      <SecHead code="O" title="The Object" tag="CONCEPT · WHAT THE CUSTOMER SEES">
        A circular black-and-white calm-display object that sits on a desk or bedside table. Silent by default,
        ...
        <div className="object-side">
          ...
          <div className="glance-note">
            ...
            <div className="glance-text">
              ...
              <p>A calm black/white UI in <b>Space Mono</b>, rendered on a backlit <b>2.8″ LCD</b>. One dominant
                thing in the centre, supporting data in the mid-ring, ambient status on the perimeter. No animation,
                no colour, no icons — terminal restraint. A quiet screen after a good day is the product working.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="page">
      <header className="masthead">
        <div className="mh-top">
          ...
          <div className="mh-top-r">
            <div className="mh-rev">REV V1 · DEMO UNIT · 2026</div>
            <a className="mh-nav" href="Gravity Hardware Drawings.html">ENGINEERING DRAWING SET →</a>
          </div>
        </div>
